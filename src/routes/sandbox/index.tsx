...
export default component$(() => {
    ...
    const addOffensePlayer = $(async () => {
        ...
        let fieldPoint;
        if (field) {
            fieldPoint = field.bounds.center.add(new paper.Point(0, 400));
        }
    ...
    const moveToolMouseDownHandler = $((e: any) => {
        const isOnCanvas = e.target.classList.contains('sandbox-wrap');
